    ...
    try {
      ...
      switch(apiName) {
        ...
        case 'shotstack':
          ...
          isValid = !shotstackResult.error && shotstackResult.data && shotstackResult.data.success;
        ...
        case 'elevenlabs':
          ...
          isValid = !elevenLabsResult.error && elevenLabsResult.data && elevenLabsResult.data.success;
