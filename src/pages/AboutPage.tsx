  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950">
      ...
      <div className="container px-4 md:px-6 py-12 max-w-6xl mx-auto">
        <h1 className="text-3xl md:text-5xl font-bold mb-6 text-center text-gray-900 dark:text-white">About SmartVid</h1>
        ...
        {/* Our Mission Section */}
        <div className="mb-16 bg-gray-100 dark:bg-gray-850 rounded-2xl p-8 md:p-12">
          <h2 className="text-2xl md:text-3xl font-bold mb-6 text-gray-900 dark:text-white">Our Mission</h2>
        ...
        {/* Technology Section */}
        <div className="mb-16">
          <h2 className="text-2xl md:text-3xl font-bold mb-6 text-gray-900 dark:text-white">Our Technology</h2>
        ...
        {/* Join Us Section */}
        <div className="text-center py-12 px-6 bg-smartvid-50 dark:bg-smartvid-900/20 rounded-2xl mb-16">
          <h2 className="text-2xl md:text-3xl font-bold mb-4 text-gray-900 dark:text-white">Join the Video Revolution</h2>
