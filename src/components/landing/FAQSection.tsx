...
export function FAQSection() {
  ...
  const [faqs, setFaqs] = useState([
    {
      question: "How does Smart Videofy work?",
      answer: "Smart Videofy uses AI to analyze your text prompt, break it into scenes, find relevant stock video clips, and assemble them into a cohesive video with transitions, text overlays, and optional voiceovers. The entire process is automated, requiring minimal input from you.",
      isOpen: false
    },
    {
    ...
    },
    {
      ...
      answer: "Smart Videofy generates videos in MP4 format. Free users get 720p resolution, while Pro users get 1080p and Business users get up to 4K resolution. All videos can be downloaded and used immediately after generation.",
      isOpen: false
    },
    {
      question: "Do I own the videos I create?",
      answer: "Yes, you own all rights to the videos you create with Smart Videofy. The stock footage we provide is licensed for your commercial use without attribution requirements or additional fees.",
      isOpen: false
    },
    {
      question: "Do I need technical skills to use Smart Videofy?",
      answer: "Not at all! Smart Videofy is designed to be user-friendly and intuitive. If you can type a description of what you want, our AI can turn it into a video. No video editing, design, or technical skills required.",
      isOpen: false
    },
    {
      question: "Can I add voice narration to my videos?",
      answer: "Yes! Smart Videofy offers AI-powered voiceovers in multiple languages and voices. You can either write your own script or let our AI generate one based on your video content.",
      isOpen: false
    },
    {
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-gray-500 md:text-xl dark:text-gray-400">
              Find answers to common questions about Smart Videofy's features, pricing, and capabilities.
            </p>
          </div>
