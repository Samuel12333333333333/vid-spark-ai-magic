...
// Create a custom temporary type for our database that's compatible with the existing code
// This is necessary since we can't modify the types.ts file directly
type CustomDatabase = {
  public: {
    Tables: {
      profiles: {
